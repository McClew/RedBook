...
* **Function:** Allows us to modify a single request and resend it multiple times to analyse the response.
* **Usage:** We can send requests here from the Proxy history to manually test for vulnerabilities.
...
* **Key Advantage:** **No Rate Limiting.** Unlike Burp Community, Caido’s free version allows us to run "Automate" attacks at full speed.
...
The free version of Caido allows for up to 3 plugins installed.
