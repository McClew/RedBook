...
SocksOverRDP is an example of a tool that uses `Dynamic Virtual Channels` (`DVC`) from the Remote Desktop Service feature of Windows.
...
<figure><img src="../../../.gitbook/assets/configuringproxifier.gif" alt=""><figcaption></figcaption></figure>
