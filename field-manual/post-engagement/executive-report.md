...
The same audience and constraints described in Executive Summary apply here, only more so: this document may be the only part of the engagement's output that some readers ever see. Assume no technical background, a short attention span, and zero appetite for looking anything up.
...
* Reproduction steps, payloads, or credentials of any kind
* CVSS breakdowns, CWE references, or other technical scoring detail
* Vendor or product names beyond what's already been cleared for use in the Executive Summary
